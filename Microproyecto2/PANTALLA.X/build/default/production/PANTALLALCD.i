...
void Lcd_Cmd(unsigned char cmd) {
    LATBbits.LATB0 = 0;
    Lcd_Port(cmd >> 4);
    LATBbits.LATB1 = 1; _delay((unsigned long)((2)*(8000000/4000.0))); LATBbits.LATB1 = 0;
    Lcd_Port(cmd & 0x0F);
    LATBbits.LATB1 = 1; _delay((unsigned long)((2)*(8000000/4000.0))); LATBbits.LATB1 = 0;
}
