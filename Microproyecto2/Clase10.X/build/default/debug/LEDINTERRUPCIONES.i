...
volatile unsigned char secuencia=0;
volatile unsigned char modo =0;
volatile unsigned int velocidad=500;



void delay_ms(unsigned int tiempo){
    while(tiempo--)_delay((unsigned long)((1)*(8000000/4000.0)));
}
